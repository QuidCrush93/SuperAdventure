...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public Player(int currentHitPoints, int maximumHitPoints, int gold, int experiencePoints, int level, Location currentLocation = null) : base(currentHitPoints, maximumHitPoints)
        {
            Gold = gold;
